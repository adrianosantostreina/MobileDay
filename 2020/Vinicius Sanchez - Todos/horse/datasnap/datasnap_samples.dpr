...
uses
  ...
  Web.WebBroker,
  Datasnap.DSSession,
  Server.Methods in 'src\Server.Methods.pas',
  Server.WebModule in 'src\Server.WebModule.pas' {WebModule1: TWebModule},
  Server.Consts in 'src\Server.Consts.pas';
